...
2. Each rule uses the tree only to _locate_ things, then emits targeted string edits
...
_allowed_ to make (positions, tight/loose `spread`, adjacent bullet lists merged by marker
